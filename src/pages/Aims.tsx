...
const Aims: React.FC = () => {
  ...
  const objectives = [
    { id: 1, icon: <Users size={24} />, titleEn: 'Unity and Brotherhood', titleOl: 'ᱢᱤᱫ ᱡᱩᱢᱤᱫᱽ ᱟᱨ ᱵᱚᱭᱦᱟ ᱥᱟᱹᱜᱟᱹᱭ', descEn: 'To foster a sense of unity and brotherhood among Santal engineering students.', descOl: 'ᱥᱟᱱᱛᱟᱲ ᱤᱱᱡᱤᱱᱤᱭᱟᱨᱤᱝ ᱯᱟᱹᱴᱷᱩᱣᱟᱹ ᱠᱚ ᱢᱩᱫᱽ ᱨᱮ ᱢᱤᱫ ᱡᱩᱢᱤᱫᱽ ᱟᱨ ᱵᱚᱭᱦᱟ ᱥᱟᱹᱜᱟᱹᱭ ᱛᱮᱭᱟᱨ ᱾' },
    ...
    { id: 11, icon: <Shield size={24} />, titleEn: 'Legal Aid and Rights', titleOl: 'ᱟᱹᱭᱫᱟᱹᱨ ᱟᱨ ᱜᱚᱲᱚ', descEn: 'To protect the rights and interests of Santal engineering students.', descOl: 'ᱥᱟᱱᱛᱟᱲ ᱤᱱᱡᱤᱱᱤᱭᱟᱨᱤᱝ ᱯᱟᱹᱴᱷᱩᱣᱟᱹ ᱠᱚᱣᱟᱜ ᱟᱹᱭᱫᱟᱹᱨ ᱡᱚᱜᱟᱣ ᱾' },
